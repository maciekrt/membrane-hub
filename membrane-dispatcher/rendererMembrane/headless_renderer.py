...
class HeadlessRenderer(object):
    ...
    def __init__(self, viewer, welcome=True):
        ...
        # IMPORTANT CENTRAL WIDGET LAYERS
    ...
    def _create_canvas(self) -> None:
        ...
        # self.canvas = VispyCanvasOnline(size=(800, 800))
    ...
    def closeEvent(self, event):
        ...
        # or Abort trap. (calling slstop() when no animation is occurring is also
        # not a problem)
        # self.dims.stop()
